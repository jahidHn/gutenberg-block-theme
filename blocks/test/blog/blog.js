...
( function( editor, components, i18n, element ) {
	...
	registerBlockType( 'blocks/blog', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
		...
		category: 'theme-blocks', // The category of the block.
